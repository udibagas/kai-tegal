	...
	<div>
		<div class="d-flex">
			<div class="flex-grow-1">
				<el-page-header title @back="$router.go(-1)" content="Kelola Jalur"></el-page-header>
			</div>
	...
	methods: {
		...
		deleteData(id) {
			this.$confirm("Anda yakin akan menghapus data ini?", "Perhatian", {
				...
				.then(() => {
					this.$axios.delete(`/api/jalur/${id}`).then((r) => this.getData());
				})
